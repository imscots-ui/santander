...
### The Colour Rules
Brand red: `#c8102e` — CTAs, active nav states, the top bar. Nothing else.
...
### Hierarchy Law
**One primary CTA per screen.** If you see two `bg-[#c8102e]` or two `bg-stone-900` buttons in the same view, one is wrong.
...
```bash
grep -c "bg-\[#c8102e\]\|bg-stone-900\|bg-red-" App.jsx
```
